...
<div id="homeContentRight">	
	...
	<div id="homeRightBoxContent">
		...
		<tr>
			...
			<td valign="top" width="100%">
				<div id="homeBoxTitle">Users, Roles, Agencies, Rejection Reasons, QA Indicators &amp; Flags</div>
				<div id="homeBoxLine"><img src="images/x.gif" width="1" height="5" border="0" /></div>
			  	<div id="homeBoxText">
					<table border="0">
					<tr>
					...
					<tr>
						<td width="10%"><b>QA Indicators:</b></td>
						<td width="10%"><a href="<%=Constants.CNTRL_QA_INDICATORS%>"><img src="images/home-btn-open.gif" alt="Open" width="66" height="18" border="0" vspace="5" align="absmiddle" /></a>
						</td>
						<authority:hasPrivilege privilege="<%= Privilege.MANAGE_REASONS %>" scope="<%= Privilege.SCOPE_ALL %>">
						<td>
						<form action="<%= Constants.CNTRL_CREATE_QA_INDICATOR %>" method="POST">
						<input type="hidden" name="action" value="new">
						<input type="image" src="images/home-btn-addnew.gif" name="newIndicator">
						</form>
						</td>
						</authority:hasPrivilege>						
					</tr>
					<tr>
						<td width="10%"><b>Flags:</b></td>
						<td width="10%"><a href="<%=Constants.CNTRL_FLAGS%>"><img src="images/home-btn-open.gif" alt="Open" width="66" height="18" border="0" vspace="5" align="absmiddle" /></a>
						</td>
						<authority:hasPrivilege privilege="<%= Privilege.MANAGE_REASONS %>" scope="<%= Privilege.SCOPE_ALL %>">
						<td>
						<form action="<%= Constants.CNTRL_CREATE_FLAG %>" method="POST">
						<input type="hidden" name="action" value="new">
						<input type="image" src="images/home-btn-addnew.gif" name="newFlag">
						</form>
						</td>
						</authority:hasPrivilege>						
					</tr>
