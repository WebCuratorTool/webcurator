...
function validate_internal() {
	if (validateText(document.CustomDepositForm.customDepositForm_bibliographicCitation.value) == false) {
...
function ajaxFunction_internal(requestParams, destinationDiv, asynchronousFlag) {
	...
	xmlhttp.open("POST", "/customDepositForms/rosetta_interface_via_ajax.jsp", asynchronousFlag);
...
<tr>
<td>Issue Number: </td>
<td><input size="25" title="Issue Number" type="text" name="customDepositForm_bibliographicCitation"/></td>
<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
...
<td><input size="25" title="Year of Publication" type="text" name="customDepositForm_dctermsIssued"/></td>
END COMMENTED   -->
