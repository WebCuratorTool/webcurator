...
public class AttachmentView extends AbstractView {
    ...
    /** The file on the server to be sent. */
	private File file = null;
	/** The name of the file, as seen by the browser. */
	 ...
	 * @param filename The name of the file as seen by the browser.
	 ...
	 */
	public AttachmentView(String filename, File file, boolean deleteAfterSend) {
		this.file = file;
	...
	protected void renderMergedOutputModel(Map model, HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		try {
			...
			{
				response.setHeader("Content-typeapplication","text/plain");
			...
			{
				String message = "Unable to download file: "+filename+". The file is not available.";
