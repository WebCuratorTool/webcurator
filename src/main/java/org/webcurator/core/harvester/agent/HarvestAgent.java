...
public interface HarvestAgent {
     ...
     *
     * @param job     the unique id of the harvest job
     ...
     * @param profile the profile to use for the new Harvest.
     */
    void updateProfileOverrides(String job, String profile);
     ...
     *
     * @param job            the name of the harvest job
     * @param bandwidthLimit the bandwidth limit
     */
    void restrictBandwidth(String job, int bandwidthLimit);

    /**
     * Pause the specified running harvest job.
     *
     * @param job the name of the harvest job to pause
     */
    void pause(String job);

    /**
     * Resume the specified paused harvest job.
     *
     * @param job the name of the harvest job to resume.
     */
    void resume(String job);

    /**
     * Abort the specified running harvest job.
     *
     * @param job the name of the harvest job to abort
     */
    void abort(String job);

    /**
     * Stop and complete the specified running harvest job.
     *
     * @param job the name of the harvest job to stop
     */
    void stop(String job);
     ...
     * @param failureStep the step that the last harvest complete failed on
     */
    int completeHarvest(String job, int failureStep);

    /**
     * Load the settings for the job.
     *
     * @param job the job to load the settings for
     */
    void loadSettings(String job);
