...
public class ProfileOverridesTest extends BaseWCTTest<ProfileOverrides> {
	...
	public final void testApply_overrideMaxLinkHops() 
	{
		try
		{
			...
			String result = getResult("/crawl-order/controller/newObject[@name='scope']/newObject/map/newObject[@name='rejectIfTooManyHops']/integer[@name='max-hops']");
			assertTrue(result.equals(""));
			result = getResult("/crawl-order/controller/newObject[@name='scope']/newObject/map/newObject[@name='acceptIfTranscluded']/integer[@name='max-trans-hops']");
			assertTrue(result.equals(""));
			result = getResult("/crawl-order/controller/newObject[@name='scope']/newObject/map/newObject[@name='_wct_max_hops']/integer[@name='max-hops']");
			assertTrue(result.equals(value.toString()));
			result = getResult("/crawl-order/controller/newObject[@name='scope']/newObject/map/newObject[@name='_wct_max_trans_hops']/integer[@name='max-trans-hops']");
			assertTrue(result.equals(value.toString()));
		}
		catch(Exception e)
		{
	...
	public final void testApply_overrideMaxPathDepth() 
	{
		try
		{
			...
			String result = getResult("/crawl-order/controller/newObject[@name='scope']/newObject/map/newObject[@name='rejectIfTooManyPathSegs']/integer[@name='max-path-depth']");
			assertTrue(result.equals(""));
			result = getResult("/crawl-order/controller/newObject[@name='scope']/newObject/map/newObject[@name='_wct_max_depth']/integer[@name='max-path-depth']");
			assertTrue(result.equals(value.toString()));
		}
		catch(Exception e)
		{
	...
	public final void testApply_overrideExcludeUriFilters() 
	{
		try
		{
			...
			String result = getResult("/crawl-order/controller/newObject[@name='scope']/newObject/map/newObject[@name='_wct_excl_uris']/stringList/string[1]");
			assertTrue(result.equals(filter1));
			result = getResult("/crawl-order/controller/newObject[@name='scope']/newObject/map/newObject[@name='_wct_excl_uris']/stringList/string[2]");
			assertTrue(result.equals(filter2));
			result = getResult("/crawl-order/controller/newObject[@name='scope']/newObject/map/newObject[@name='_wct_excl_uris']/string[@name='list-logic']");
			assertTrue(result.equals("OR"));
			result = getResult("/crawl-order/controller/newObject[@name='scope']/newObject/map/newObject[@name='_wct_excl_uris']/string[@name='decision']");
	...
	public final void testApply_overrideIncludeUriFilters() 
	{
		try
		{
			...
			String result = getResult("/crawl-order/controller/newObject[@name='scope']/newObject/map/newObject[@name='_wct_incl_uris']/stringList/string[1]");
			assertTrue(result.equals(filter1));
			result = getResult("/crawl-order/controller/newObject[@name='scope']/newObject/map/newObject[@name='_wct_incl_uris']/stringList/string[2]");
			assertTrue(result.equals(filter2));
			result = getResult("/crawl-order/controller/newObject[@name='scope']/newObject/map/newObject[@name='_wct_incl_uris']/string[@name='list-logic']");
			assertTrue(result.equals("OR"));
			result = getResult("/crawl-order/controller/newObject[@name='scope']/newObject/map/newObject[@name='_wct_incl_uris']/string[@name='decision']");
