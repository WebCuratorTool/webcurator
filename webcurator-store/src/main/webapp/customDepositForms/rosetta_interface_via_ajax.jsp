...
<%
	...
	response.addHeader("Access-Control-Allow-Origin", dpsArchive.getWebappBaseUrl());
...
%><b>Preset producer does not match available producers for the user <%= producerAgent %> in Rosetta</b><%
	...
	<input title="Producer" name="customDepositForm_producerId" type="hidden" value="<%= prodId %>"/><%
	}
}
