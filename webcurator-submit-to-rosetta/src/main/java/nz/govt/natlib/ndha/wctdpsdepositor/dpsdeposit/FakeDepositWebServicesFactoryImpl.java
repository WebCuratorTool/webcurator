...
public class FakeDepositWebServicesFactoryImpl implements DepositWebServicesFactory {
    private FakeDepositWebService depositWebService = new FakeDepositWebService();

    public DepositWebServices createInstance(WctDepositParameter depositParameter) {
        return depositWebService;
    }
