package org.webcurator.core.visualization.networkmap.graph;
...
public class PhysicsGravity {
    private NetworkMapOptions options;
    private List<GraphNode> nodes;
    private List<GraphNode> forces;
    private int width, height;

    public PhysicsGravity(NetworkMapOptions options, int width, int height) {
