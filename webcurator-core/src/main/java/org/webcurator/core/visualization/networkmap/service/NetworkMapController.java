...
public class NetworkMapController implements NetworkMapService {
    ...
    @Override
    @RequestMapping(path = VisualizationConstants.PATH_GET_COMMON, method = {RequestMethod.POST, RequestMethod.GET})
    ...
    @Override
    @RequestMapping(path = VisualizationConstants.PATH_GET_NODE, method = {RequestMethod.POST, RequestMethod.GET})
    ...
    @Override
    @RequestMapping(path = VisualizationConstants.PATH_GET_OUTLINKS, method = {RequestMethod.POST, RequestMethod.GET})
    ...
    @Override
    @RequestMapping(path = VisualizationConstants.PATH_GET_CHILDREN, method = {RequestMethod.POST, RequestMethod.GET})
    ...
    @Override
    @RequestMapping(path = VisualizationConstants.PATH_GET_ALL_DOMAINS, method = {RequestMethod.POST, RequestMethod.GET})
    ...
    @Override
    @RequestMapping(path = VisualizationConstants.PATH_GET_ROOT_URLS, method = {RequestMethod.POST, RequestMethod.GET})
    ...
    @Override
    @RequestMapping(path = VisualizationConstants.PATH_GET_MALFORMED_URLS, method = {RequestMethod.POST, RequestMethod.GET})
    ...
    @Override
    @RequestMapping(path = VisualizationConstants.PATH_SEARCH_URLS, method = {RequestMethod.POST, RequestMethod.GET})
    ...
    @Override
    @RequestMapping(path = VisualizationConstants.PATH_GET_HOP_PATH, method = {RequestMethod.POST, RequestMethod.GET})
    ...
    @Override
    @RequestMapping(path = VisualizationConstants.PATH_GET_HIERARCHY_URLS, method = {RequestMethod.POST, RequestMethod.GET})
