...
public class HarvestAgentPaths {
    ...
    public static final String NAME = ROOT_PATH + "/name";
    public static final String MEMORY_WARNING = ROOT_PATH + "/memory-warning";
    ...
    public static final String COMPLETE_HARVEST = ROOT_PATH + "/{job}/complete-harvest";
