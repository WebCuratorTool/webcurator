...
public class QaRecommendationService {
	 ...
	 * the logger
	 */
	private static final Log LOG = LogFactory.getLog(QaRecommendationService.class);

	public QaRecommendationService() {
	}
	...
	public final void buildKnowledgeSession() {
		if (ksession == null) {
	        ...
	        kbuilder.add( ResourceFactory.newClassPathResource( rulesFileName, QaRecommendationService.class ),
	                      ResourceType.DRL );
