...
public class TargetManager2 extends TargetManager {
	/** The logger for the Target Manager */
	private static Log log = LogFactory.getLog(TargetManager2.class);
	...
	public void save(Target aTarget, List<GroupMemberDTO> parents) {
		...
		// Removed this block because the ReST API has its own authorization
