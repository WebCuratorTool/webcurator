...
public class WCTResourceIndexerTest {
    ...
    public void testWCTResourceIndexer() throws IOException {
        ...
        ResourceExtractorProcessor indexer = new ResourceExtractorProcessor(new File(directory), db, targetInstanceId, harvestResultNumber, null, null);

        indexer.indexFiles();

        VisualizationProgressBar progressBar = ResourceExtractorProcessor.getProgress(targetInstanceId, harvestResultNumber);
        ...
        indexer.clear();
        progressBar = ResourceExtractorProcessor.getProgress(targetInstanceId, harvestResultNumber);
        assert progressBar == null;
    }
...
////        ResourceExtractorProcessor indexer = new ResourceExtractorProcessor(directory, null, 5010, 2);
//        ResourceExtractorProcessor indexer = new ResourceExtractorProcessor();
//
