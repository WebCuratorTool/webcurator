...
public class Heritrix3ProfileValidator extends AbstractBaseValidator {
    ...
    public void validate(Object comm, Errors errors) {
        ...
        boolean isValidBlockUrls = ProfileUtil.rejectInvalidRegexes(errors, "blockUrls", command.getBlockUrls());
        boolean isValidIncludeUrls = ProfileUtil.rejectInvalidRegexes(errors, "includeUrls", command.getIncludeUrls());
