...
/**
 * The command object for the Quality review tools.
 * @author bbeaumont
 */
public class QualityReviewToolCommand {
	...
	public void setHarvestResultId(long harvestResourceOid) {
		this.harvestResultId = harvestResourceOid;
	}
