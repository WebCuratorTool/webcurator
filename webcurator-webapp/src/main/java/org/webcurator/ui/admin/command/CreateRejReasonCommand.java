 ...
 * @author oakleigh_sk
 */
public class CreateRejReasonCommand {
    ...
    /** the name field. */
    private String name;
    /** the availableForTargets field. */
    private boolean availableForTargets;
    /** the availableForTIs field. */
    ...
    private CreateRejReasonCommand command;
	 ...
	 * @return the command
	 */
	public CreateRejReasonCommand getCommand() {
		return command;
	}
	/**
	 * @param command the command to set
	 */
	public void setCommand(CreateRejReasonCommand command) {
	...
	/**
	 * @param availableForTargets the availableForTargets to set.
	 */
	...
	/**
	 * @param availableForTIs the availableForTIs to set.
	 */
