...
/**
 * The Command object for modifying a user.
 * @author bprice
 */
public class UserCommand {
    ...
    /** The name of the associate roles to user action */
    public static final String ACTION_MANAGE_ROLES = "manageRoles";
    /** The name of the change user active status */
    ...
    /** the name of the user DTO's model object. */
    public static final String MDL_USERS = "userDTOs";
