...
/**
 * Binds together the profile related info, to be used in the groups, targets
 * and target-instances responses.
 */
public class ProfileInfoDTO {
    ...
    public ProfileInfoDTO(TargetInstance targetInstance) {
        Profile p = targetInstance.getProfile();
        ProfileOverrides o = targetInstance.getProfileOverrides();
        init(p, o);
    }

    public ProfileInfoDTO(AbstractTarget abstractTarget) {
