...
<div id="resultsTable">
    ...
    <div>
        ...
        <div style="display: inline-block; width: 33%; vertical-align:top;">
            <table cellpadding="3" cellspacing="0" border="0" width="100%">
                <tr><th class="tableHead" colspan="3">Modifying Logs</th></tr>
                <c:choose>
        ...
        <div style="display: inline-block; width: 33%; vertical-align:top;">
            <table cellpadding="3" cellspacing="0" border="0" width="100%">
                <tr><th class="tableHead" colspan="3">Indexing Logs</th></tr>
                <c:choose>
    ...
    <table width="100%" cellpadding="2" cellspacing="0" border="0">
        ...
        <tr>
            <td width="100%">
                    <c:choose>
                        <c:when test="${empty listToBePruned.rows}">
                        <table cellpadding="3" cellspacing="0" border="0" width="100%">
                            <tr>
                        ...
                        <table cellpadding="3" cellspacing="0" border="0" width="100%">
                            ...
                            <c:forEach items="${listToBePruned.rows}" var="e">
                            <tr>
                                <td class="subBoxText">
                                    <c:out value="${e.url}"/>
                                </td>
                            ...
                            <tr>
                              <td class="subBoxText">
                                 <a href="curator/target/modification/view/more.html?targetInstanceOid=${ti.oid}&harvestResultNumber=${hr.harvestNumber}&action=prune">More...</a>
                              </td>
                            </tr>
                            </c:if>
                        </table>
        ...
        <tr>
            <td width="100%">
                    <c:choose>
                        <c:when test="${empty listToBeImportedByFile.rows}">
                        <table cellpadding="3" cellspacing="0" border="0" width="100%">
                            <tr>
                        ...
                        <table cellpadding="3" cellspacing="0" border="0" width="100%">
                            ...
                            <c:forEach items="${listToBeImportedByFile.rows}" var="e">
                            <tr>
                                <td class="subBoxText">
                                    <c:out value="${e.url}"/>
                                </td>
                            ...
                            <c:if test="${listToBePruned.more}">
                                <tr>
                                  <td class="subBoxText">
                                     <a href="curator/target/modification/view/more.html?targetInstanceOid=${ti.oid}&harvestResultNumber=${hr.harvestNumber}&action=file">More...</a>
                                  </td>
                                </tr>
                            </c:if>
                        </table>
        ...
        <tr>
            <td width="100%">
                    <c:choose>
                        <c:when test="${empty listToBeImportedByURL.rows}">
                        <table cellpadding="3" cellspacing="0" border="0" width="100%">
                            <tr>
                        ...
                        <table cellpadding="3" cellspacing="0" border="0" width="100%">
                            ...
                            <c:forEach items="${listToBeImportedByURL.rows}" var="e">
                            <tr>
                                <td class="subBoxText">
                                    <c:out value="${e.url}"/>
                                </td>
                            ...
                            <c:if test="${listToBePruned.more}">
                                <tr>
                                  <td class="subBoxText">
                                     <a href="curator/target/modification/view/more.html?targetInstanceOid=${ti.oid}&harvestResultNumber=${hr.harvestNumber}&action=url">More...</a>
                                  </td>
                                </tr>
                            </c:if>
                        </table>
