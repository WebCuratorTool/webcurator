...
<br/>
<center>
<a href="curator/target/quality-review-toc.html?targetInstanceOid=${sessionTargetInstance.oid}&harvestResultId=${harvestResultId}&harvestNumber=${harvestNumber}"><img src="images/generic-btn-done.gif" border="0"></a>
</center>
