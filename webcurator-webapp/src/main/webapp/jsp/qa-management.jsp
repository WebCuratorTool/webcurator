...
<div id="homeRightBoxContent">
	...
	<tr>
		...
		<td valign="top" width="100%">
			<div id="homeBoxTitle">Users, Roles, Agencies, Rejection Reasons &amp; QA Indicators</div>
			<div id="homeBoxLine"><img src="images/x.gif" width="1" height="5" border="0" /></div>
			<div id="homeBoxText">
				<table border="0">
				<tr>
				...
				<tr>
					<td><b>QA&nbsp;Indicators:</b></td>
					<td><a href="<%=Constants.CNTRL_QA_INDICATORS%>"><img src="images/home-btn-open.gif" alt="Open" width="66" height="18" border="0" vspace="5" align="absmiddle" /></a></td>
					<authority:hasPrivilege privilege="<%= Privilege.MANAGE_REASONS %>" scope="<%= Privilege.SCOPE_ALL %>">
					<td>
						<form action="<%= Constants.CNTRL_CREATE_REASON %>" method="POST">
						<input type="hidden" name="action" value="new">
						<input type="image" src="images/home-btn-addnew.gif" name="newIndicator">
									...
									<tr>
					<td><b>Flags:</b></td>
					<td><a href="<%=Constants.CNTRL_FLAGS%>"><img src="images/home-btn-open.gif" alt="Open" width="66" height="18" border="0" vspace="5" align="absmiddle" /></a></td>
					<authority:hasPrivilege privilege="<%= Privilege.MANAGE_REASONS %>" scope="<%= Privilege.SCOPE_ALL %>">
					<td>
