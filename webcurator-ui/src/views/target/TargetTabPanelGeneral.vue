  ...
  <div class="card p-fluid">
    <div class="grid" id="grid-form">
      ...
      <WctFormField label="Owner">
        <Dropdown id="user" v-model="fields.selectedUser" :options="users.userList" placeholder="Select an User"
          checkmark class="w-full md:w-18rem" :disabled="readOnly">
