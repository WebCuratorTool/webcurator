...
rem The dependency resolver claims this should be in the repo as well
call mvn install:install-file -DgroupId=com.anotherbigidea -DartifactId=javaswf -Dversion=CVS-SNAPSHOT-1 -Dpackaging=jar -Dfile=.\wct-core\target\heritrix-1-14-adjust\lib\javaswf-CVS-SNAPSHOT-1.jar
